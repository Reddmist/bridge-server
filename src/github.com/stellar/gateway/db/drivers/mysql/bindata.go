...
func migrations_gateway01_initSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations_gateway/01_init.sql", size: 847, mode: os.FileMode(420), modTime: time.Unix(1505124461, 0)}
...
func migrations_gateway02_transaction_idSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations_gateway/02_transaction_id.sql", size: 164, mode: os.FileMode(420), modTime: time.Unix(1506421638, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func migrations_compliance01_initSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations_compliance/01_init.sql", size: 1133, mode: os.FileMode(420), modTime: time.Unix(1505124461, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
